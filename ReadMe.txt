...
java -jar modules/swagger-codegen-cli/target/swagger-codegen-cli.jar generate -i http://localhost:8081/Hurricane/api-docs -l dynamic-html -o C:/Dev/Applications/Hurricane/src/main/webapp

4) Redeploy the web service with the new documentation

Deploying to the cloud:

Make sure that you change the log file location to ${catalina.base}/logs/hurricane.txt